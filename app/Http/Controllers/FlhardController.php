...
class FlhardController extends Controller
{
    public function showQuestion(Request $request)
    {
        ...
        if ($questionNumber > 10) {
            return redirect()->route('flhard.result');
        }
    ...
    public function start(Request $request)
    {
        ...
        return redirect()->route('flhard.show');
    }
    ...
    public function reset(Request $request)
    {
        ...
        return redirect()->route('flhard.startForm');
        }
    ...
    public function leaderboard()
    {
        ...
        $topScores = FlagHardScore::orderBy('score', 'desc')->take(10)->get();

        return view('flhard_leaderboard', ['topScores' => $topScores]);
    }
