...
<body>
    ...
    <div class="container" style="display:flex; flex-direction:row; justify-content:space-evenly;">
        ...
        <div style="margin-top: 1rem; display: flex;">
            <a href="{{ route('quiz.start') }}"><button type="button" class="primary" style="padding: 3rem 4rem;">&#127752; <br> Normal Mode</button></a>
        </div>
        <div style="margin-top: 1rem; display: flex;">
            <a href="{{ route('hard-quiz.start') }}"><button type="button" class="primary" style="padding: 3rem 4rem;">&#127919; <br> Hard Mode</button></a>
        </div>
    </div>
